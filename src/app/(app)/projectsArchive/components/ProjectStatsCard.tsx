...
import { Clock, GitBranch, TrendingUp, Users } from 'lucide-react'
      ...
      {project.stats.uptime && (
        <div className="flex items-center gap-2 px-4 py-2 bg-emerald-500/5 border border-emerald-500/10 rounded-xl">
          ...
          <span className="text-[10px] font-mono text-emerald-500 uppercase tracking-widest">
            System Uptime: {project.stats.uptime}
          </span>
        </div>
      )}
    </div>
...
const StatItem = memo(
  ({
    ...
    >
      ...
      <div
        className={cn(
          'absolute -bottom-4 -right-4 size-16 opacity-0 group-hover:opacity-10 transition-opacity',
