...
import { redirect } from 'next/navigation' // DODANO: brakujący import
...
export default async function FilesPage({
  ...
  if (q) {
    where.or = [{ filename: { contains: q } }, { description: { contains: q } }]
  }
  ...
  return (
    <div className="space-y-12">
      ...
      {/* REPOSITORY SECTION - Połączono w jeden spójny blok */}
