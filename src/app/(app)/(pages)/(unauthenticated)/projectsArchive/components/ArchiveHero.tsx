      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-center gap-4 py-4">
            ...
            <span className="text-xs font-mono text-neutral-500 tracking-[0.5em] uppercase">
        ...
        <p className="max-w-2xl mx-auto text-neutral-400 text-lg md:text-xl leading-relaxed font-light">
          Explore the definitive collection of our production-grade systems, algorithmic
          experiments, and full-stack architecture deployments, curated for technical rigor.
        </p>
...
const TechTag = memo(({ icon: Icon, label }: { icon: LucideIcon; label: string }) => (
