            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex justify-between items-start">
                  <h3 className="text-lg font-black tracking-tighter uppercase mb-1">Ciasteczka</h3>
                  <button
                ...
                <p className="text-[11px] text-neutral-400  leading-relaxed mb-6 uppercase tracking-wider">
                ...
                <div className="flex flex-col gap-2">
                  <Button
                    onClick={acceptAll}
                    className="w-full bg-primary hover:bg-primary/90  font-black tracking-widest text-[10px] uppercase h-11 rounded-xl group"
                  >
                    Akceptuj Wszystkie
                    <ChevronRight
                      size={14}
