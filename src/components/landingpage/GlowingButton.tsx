...
const GlowingButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        'relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-slate-50',
        className,
      )}
    >
