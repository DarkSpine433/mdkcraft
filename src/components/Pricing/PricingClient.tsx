...
import { Mail, MousePointer2, ShieldCheck, Zap } from 'lucide-react'
    ...
    <div className="relative min-h-screen bg-[#020204] text-white overflow-hidden selection:bg-primary/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <header className="mb-20">
          ...
          >
            Skorzystaj z naszego interaktywnego konfiguratora, aby otrzymać wstępną wycenę. Przejdź
            przez 5 kroków i prześlij nam swój brief do analizy.
          </motion.p>
        </header>
        ...
        <div className="space-y-20">
          ...
          >
            <div className="bg-[#050507] rounded-[22px] p-8 md:p-10 border border-white/5 shadow-2xl">
              <ConfiguratorForm />
            </div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className=" ">
                {[
                  ...
                  <motion.a
                    ...
                    className="group flex items-center gap-6 p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-primary/50 hover:bg-white/10 transition-all duration-500 w-fit"
                  >
            ...
            <div className="p-8 rounded-2xl border border-white/5 bg-gradient-to-br from-primary/5 to-transparent h-fit self-end">
              <h3 className="text-sm font-bold mb-6 flex items-center gap-2 uppercase tracking-tighter">
                <Zap size={16} className="text-primary" /> Intelligent Estimation
              </h3>
              <ul className="space-y-4">
                {[
                  `Dostosowane do trendów UI/UX ${new Date().getFullYear()}`,
                  'Fokus na konwersję i wydajność',
        ...
        >
          <div className="flex items-center gap-2 text-xs font-mono tracking-tighter">
            <ShieldCheck size={14} className="text-primary" /> SECURE ESTIMATION
          </div>
          <div className="flex items-center gap-2 text-xs font-mono tracking-tighter">
            <Zap size={14} className="text-primary" /> CLOUD POWERED
          </div>
          <div className="flex items-center gap-2 text-xs font-mono tracking-tighter">
            <MousePointer2 size={14} className="text-primary" /> CUSTOM SOLUTIONS
          </div>
        </motion.div>
      </div>
    </div>
